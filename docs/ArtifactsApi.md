...
import com.octopus.client.api.ArtifactsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ArtifactResource body = new ArtifactResource(); // ArtifactResource | The ArtifactResource resource to create
    try {
      ArtifactResource result = apiInstance.createArtifact(body);
...
public class Example {
  public static void main(String[] args) {
    ...
    ArtifactResource body = new ArtifactResource(); // ArtifactResource | The ArtifactResource resource to create
    try {
      ArtifactResource result = apiInstance.createArtifactSpaces(baseSpaceId, body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ArtifactsApi#createArtifactSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    ArtifactsApi apiInstance = new ArtifactsApi(defaultClient);
    String id = "id_example"; // String | ID of the ArtifactResource to delete
    try {
...
public class Example {
  public static void main(String[] args) {
    ...
    String id = "id_example"; // String | ID of the ArtifactResource to delete
    try {
      apiInstance.deleteArtifactSpaces(baseSpaceId, id);
    } catch (ApiException e) {
      System.err.println("Exception when calling ArtifactsApi#deleteArtifactSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    ArtifactsApi apiInstance = new ArtifactsApi(defaultClient);
    String id = "id_example"; // String | ID of the Artifact to load
    try {
      ArtifactResource result = apiInstance.getArtifactById(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ArtifactsApi#getArtifactById");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **String**| ID of the Artifact to load |
...
public class Example {
  public static void main(String[] args) {
    ...
    String baseSpaceId = "baseSpaceId_example"; // String | ID of the space
    try {
      ArtifactResource result = apiInstance.getArtifactByIdSpaces(id, baseSpaceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ArtifactsApi#getArtifactByIdSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    ArtifactsApi apiInstance = new ArtifactsApi(defaultClient);
    String id = "id_example"; // String | ID of the artifact
    try {
      apiInstance.getArtifactContent(id);
    } catch (ApiException e) {
      System.err.println("Exception when calling ArtifactsApi#getArtifactContent");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
**405** | Artifact content supports GET and PUT methods only. |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    String id = "id_example"; // String | ID of the artifact
    try {
      apiInstance.getArtifactContentSpaces(baseSpaceId, id);
    } catch (ApiException e) {
      System.err.println("Exception when calling ArtifactsApi#getArtifactContentSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ArtifactResourceCollection result = apiInstance.indexArtifacts(skip, take);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ArtifactsApi#indexArtifacts");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
[**ArtifactResourceCollection**](ArtifactResourceCollection.md)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | ResourceCollection_of_ArtifactResource resource returned |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer take = 56; // Integer | Number of items to take
    try {
      ArtifactResourceCollection result = apiInstance.indexArtifactsSpaces(baseSpaceId, skip, take);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ArtifactsApi#indexArtifactsSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    ArtifactsApi apiInstance = new ArtifactsApi(defaultClient);
    String id = "id_example"; // String | ID of the ArtifactResource to modify
    ArtifactResource body = new ArtifactResource(); // ArtifactResource | The ArtifactResource resource to create
    try {
      ArtifactResource result = apiInstance.updateArtifact(id, body);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    String id = "id_example"; // String | ID of the artifact
    try {
      apiInstance.updateArtifactContent(id);
    } catch (ApiException e) {
      System.err.println("Exception when calling ArtifactsApi#updateArtifactContent");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String id = "id_example"; // String | ID of the artifact
    try {
      apiInstance.updateArtifactContentSpaces(baseSpaceId, id);
    } catch (ApiException e) {
      System.err.println("Exception when calling ArtifactsApi#updateArtifactContentSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    ArtifactResource body = new ArtifactResource(); // ArtifactResource | The ArtifactResource resource to create
    try {
      ArtifactResource result = apiInstance.updateArtifactSpaces(baseSpaceId, id, body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ArtifactsApi#updateArtifactSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
