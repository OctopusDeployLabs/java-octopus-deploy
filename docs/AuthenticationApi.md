...
import com.octopus.client.api.AuthenticationApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      LoginInitiatedResource result = apiInstance.createLoginInitiated();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AuthenticationApi#createLoginInitiated");
...
|-------------|-------------|------------------|
**200** | LoginInitiatedResource resource returned |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    AuthenticationApi apiInstance = new AuthenticationApi(defaultClient);
    try {
      AuthenticationResource result = apiInstance.getAuthentication();
      System.out.println(result);
    } catch (ApiException e) {
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | AuthenticationResource resource returned |  -  |
