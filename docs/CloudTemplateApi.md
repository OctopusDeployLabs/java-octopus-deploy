...
import com.octopus.client.api.CloudTemplateApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    CloudTemplateApi apiInstance = new CloudTemplateApi(defaultClient);
    String id = "id_example"; // String | ID of the resource
    try {
      CloudTemplateMetadata result = apiInstance.createCloudTemplateMetadata(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CloudTemplateApi#createCloudTemplateMetadata");
...
|-------------|-------------|------------------|
**200** | CloudTemplateMetadata resource returned |  -  |
