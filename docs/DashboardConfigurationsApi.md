...
import com.octopus.client.api.DashboardConfigurationsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    DashboardConfigurationsApi apiInstance = new DashboardConfigurationsApi(defaultClient);
    try {
      DashboardConfigurationResource result = apiInstance.getDashboardConfiguration();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DashboardConfigurationsApi#getDashboardConfiguration");
...
|-------------|-------------|------------------|
**200** | DashboardConfigurationResource resource returned |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      DashboardConfigurationResource result = apiInstance.getDashboardConfigurationSpaces(baseSpaceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DashboardConfigurationsApi#getDashboardConfigurationSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    DashboardConfigurationsApi apiInstance = new DashboardConfigurationsApi(defaultClient);
    try {
      DashboardConfigurationResource result = apiInstance.updateDashboardConfiguration();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DashboardConfigurationsApi#updateDashboardConfiguration");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String baseSpaceId = "baseSpaceId_example"; // String | ID of the space
    try {
      DashboardConfigurationResource result = apiInstance.updateDashboardConfigurationSpaces(baseSpaceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DashboardConfigurationsApi#updateDashboardConfigurationSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
