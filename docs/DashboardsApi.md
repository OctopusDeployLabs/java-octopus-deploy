...
import com.octopus.client.api.DashboardsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      DashboardResource result = apiInstance.getDashboardView();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DashboardsApi#getDashboardView");
...
|-------------|-------------|------------------|
**200** | DashboardResource resource returned |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      DashboardResource result = apiInstance.getDashboardViewSpaces(baseSpaceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DashboardsApi#getDashboardViewSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    DashboardsApi apiInstance = new DashboardsApi(defaultClient);
    try {
      DashboardResource result = apiInstance.getDynamicDashboardView();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DashboardsApi#getDynamicDashboardView");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String baseSpaceId = "baseSpaceId_example"; // String | ID of the space
    try {
      DashboardResource result = apiInstance.getDynamicDashboardViewSpaces(baseSpaceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DashboardsApi#getDynamicDashboardViewSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
