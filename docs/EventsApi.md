...
import com.octopus.client.api.EventsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      EventResource result = apiInstance.getEvent(id);
...
|-------------|-------------|------------------|
**200** | EventResource resource returned |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    String id = "id_example"; // String | ID of the resource
    try {
      EventResource result = apiInstance.getEventSpaces(baseSpaceId, id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling EventsApi#getEventSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
# **getListEventAgents**
> List&lt;EventAgentResource&gt; getListEventAgents()
...
public class Example {
  public static void main(String[] args) {
    ...
    EventsApi apiInstance = new EventsApi(defaultClient);
    try {
      List<EventAgentResource> result = apiInstance.getListEventAgents();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling EventsApi#getListEventAgents");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | IEnumerable_of_EventAgentResource resource returned |  -  |

<a name="getListEventAgentsSpaces"></a>
# **getListEventAgentsSpaces**
> List&lt;EventAgentResource&gt; getListEventAgentsSpaces(baseSpaceId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String baseSpaceId = "baseSpaceId_example"; // String | ID of the space
    try {
      List<EventAgentResource> result = apiInstance.getListEventAgentsSpaces(baseSpaceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling EventsApi#getListEventAgentsSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
> List&lt;EventCategoryResource&gt; getListEventCategories()
...
public class Example {
  public static void main(String[] args) {
    ...
    EventsApi apiInstance = new EventsApi(defaultClient);
    try {
      List<EventCategoryResource> result = apiInstance.getListEventCategories();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling EventsApi#getListEventCategories");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | IEnumerable_of_EventCategoryResource resource returned |  -  |

<a name="getListEventCategoriesSpaces"></a>
# **getListEventCategoriesSpaces**
> List&lt;EventCategoryResource&gt; getListEventCategoriesSpaces(baseSpaceId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String baseSpaceId = "baseSpaceId_example"; // String | ID of the space
    try {
      List<EventCategoryResource> result = apiInstance.getListEventCategoriesSpaces(baseSpaceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling EventsApi#getListEventCategoriesSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
> List&lt;DocumentTypeDocument&gt; getListEventDocumentTypes()
...
public class Example {
  public static void main(String[] args) {
    ...
    EventsApi apiInstance = new EventsApi(defaultClient);
    try {
      List<DocumentTypeDocument> result = apiInstance.getListEventDocumentTypes();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling EventsApi#getListEventDocumentTypes");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | IEnumerable_of_DocumentTypeDocument resource returned |  -  |

<a name="getListEventDocumentTypesSpaces"></a>
# **getListEventDocumentTypesSpaces**
> List&lt;DocumentTypeDocument&gt; getListEventDocumentTypesSpaces(baseSpaceId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String baseSpaceId = "baseSpaceId_example"; // String | ID of the space
    try {
      List<DocumentTypeDocument> result = apiInstance.getListEventDocumentTypesSpaces(baseSpaceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling EventsApi#getListEventDocumentTypesSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
# **getListEventGroups**
> List&lt;EventGroupResource&gt; getListEventGroups()
...
public class Example {
  public static void main(String[] args) {
    ...
    EventsApi apiInstance = new EventsApi(defaultClient);
    try {
      List<EventGroupResource> result = apiInstance.getListEventGroups();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling EventsApi#getListEventGroups");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | IEnumerable_of_EventGroupResource resource returned |  -  |

<a name="getListEventGroupsSpaces"></a>
# **getListEventGroupsSpaces**
> List&lt;EventGroupResource&gt; getListEventGroupsSpaces(baseSpaceId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String baseSpaceId = "baseSpaceId_example"; // String | ID of the space
    try {
      List<EventGroupResource> result = apiInstance.getListEventGroupsSpaces(baseSpaceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling EventsApi#getListEventGroupsSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    EventsApi apiInstance = new EventsApi(defaultClient);
    try {
      apiInstance.getListEvents();
    } catch (ApiException e) {
      System.err.println("Exception when calling EventsApi#getListEvents");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | OK  ResourceCollection_of_EventResource resource returned |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    String baseSpaceId = "baseSpaceId_example"; // String | ID of the space
    try {
      apiInstance.getListEventsSpaces(baseSpaceId);
    } catch (ApiException e) {
      System.err.println("Exception when calling EventsApi#getListEventsSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
