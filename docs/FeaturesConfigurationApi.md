...
import com.octopus.client.api.FeaturesConfigurationApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    FeaturesConfigurationApi apiInstance = new FeaturesConfigurationApi(defaultClient);
    try {
      FeaturesConfigurationResource result = apiInstance.getFeaturesConfiguration();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FeaturesConfigurationApi#getFeaturesConfiguration");
...
|-------------|-------------|------------------|
**200** | FeaturesConfigurationResource resource returned |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    FeaturesConfigurationApi apiInstance = new FeaturesConfigurationApi(defaultClient);
    try {
      FeaturesConfigurationResource result = apiInstance.updateFeaturesConfiguration();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FeaturesConfigurationApi#updateFeaturesConfiguration");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
