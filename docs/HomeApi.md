...
import com.octopus.client.api.HomeApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      RootResource result = apiInstance.getHome();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling HomeApi#getHome");
...
|-------------|-------------|------------------|
**200** | RootResource resource returned |  -  |
