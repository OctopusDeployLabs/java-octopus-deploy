...
import com.octopus.client.api.JiraIntegrationApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ConnectivityCheckResponse result = apiInstance.createJiraConnectAppConnectivityCheck();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling JiraIntegrationApi#createJiraConnectAppConnectivityCheck");
...
public class Example {
  public static void main(String[] args) {
    ...
    JiraIntegrationApi apiInstance = new JiraIntegrationApi(defaultClient);
    try {
      ConnectivityCheckResponse result = apiInstance.createJiraCredentialsConnectivityCheck();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling JiraIntegrationApi#createJiraCredentialsConnectivityCheck");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
