...
import com.octopus.client.api.LicensesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      LicenseResource result = apiInstance.getLicenseGetCurrent();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling LicensesApi#getLicenseGetCurrent");
...
|-------------|-------------|------------------|
**200** | LicenseResource resource returned |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    LicensesApi apiInstance = new LicensesApi(defaultClient);
    try {
      LicenseStatusResource result = apiInstance.getLicenseStatusGetCurrent();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling LicensesApi#getLicenseStatusGetCurrent");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | LicenseStatusResource resource returned |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    LicensesApi apiInstance = new LicensesApi(defaultClient);
    try {
      LicenseResource result = apiInstance.updateLicensePutCurrent();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling LicensesApi#updateLicensePutCurrent");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
|-------------|-------------|------------------|
**200** | LicenseResource resource returned |  -  |
**400** | No request body was supplied.  Please provide the text of the license.  The license you&#39;ve provided doesn&#39;t seem to be valid XML. You should paste in the entire XML document, starting with &lt;License&gt; and ending at &lt;/License&gt;.  You cannot use this license. Attempting to use it would make this server non-compliant. |  -  |
