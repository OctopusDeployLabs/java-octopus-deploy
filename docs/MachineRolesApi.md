...
> List&lt;String&gt; getMachineRolesListAll()
...
import com.octopus.client.api.MachineRolesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    MachineRolesApi apiInstance = new MachineRolesApi(defaultClient);
    try {
      List<String> result = apiInstance.getMachineRolesListAll();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling MachineRolesApi#getMachineRolesListAll");
...
> List&lt;String&gt; getMachineRolesListAllSpaces(baseSpaceId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<String> result = apiInstance.getMachineRolesListAllSpaces(baseSpaceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling MachineRolesApi#getMachineRolesListAllSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
