...
import com.octopus.client.api.MaintenanceConfigurationApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    MaintenanceConfigurationApi apiInstance = new MaintenanceConfigurationApi(defaultClient);
    try {
      MaintenanceConfigurationResource result = apiInstance.getMaintenanceConfiguration();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling MaintenanceConfigurationApi#getMaintenanceConfiguration");
...
|-------------|-------------|------------------|
**200** | MaintenanceConfigurationResource resource returned |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    MaintenanceConfigurationApi apiInstance = new MaintenanceConfigurationApi(defaultClient);
    try {
      MaintenanceConfigurationResource result = apiInstance.updateMaintenanceConfiguration();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling MaintenanceConfigurationApi#updateMaintenanceConfiguration");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
