...
import com.octopus.client.api.OctopusServerNodesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    OctopusServerNodesApi apiInstance = new OctopusServerNodesApi(defaultClient);
    String id = "id_example"; // String | ID of the OctopusServerNodeResource to delete
    try {
      apiInstance.deleteOctopusServerNode(id);
    } catch (ApiException e) {
      System.err.println("Exception when calling OctopusServerNodesApi#deleteOctopusServerNode");
...
> List&lt;OctopusServerNodeResource&gt; getAllOctopusServerNodes()
...
public class Example {
  public static void main(String[] args) {
    ...
    OctopusServerNodesApi apiInstance = new OctopusServerNodesApi(defaultClient);
    try {
      List<OctopusServerNodeResource> result = apiInstance.getAllOctopusServerNodes();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OctopusServerNodesApi#getAllOctopusServerNodes");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
> List&lt;OctopusServerNodeResource&gt; getAllOctopusServerNodesSpaces(baseSpaceId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<OctopusServerNodeResource> result = apiInstance.getAllOctopusServerNodesSpaces(baseSpaceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OctopusServerNodesApi#getAllOctopusServerNodesSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    OctopusServerNodesApi apiInstance = new OctopusServerNodesApi(defaultClient);
    try {
      apiInstance.getLoadBalancerPing();
    } catch (ApiException e) {
      System.err.println("Exception when calling OctopusServerNodesApi#getLoadBalancerPing");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    OctopusServerNodesApi apiInstance = new OctopusServerNodesApi(defaultClient);
    try {
      apiInstance.getOctopusServerClusterSummary();
    } catch (ApiException e) {
      System.err.println("Exception when calling OctopusServerNodesApi#getOctopusServerClusterSummary");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    OctopusServerNodesApi apiInstance = new OctopusServerNodesApi(defaultClient);
    String id = "id_example"; // String | ID of the OctopusServerNode to load
    try {
      OctopusServerNodeResource result = apiInstance.getOctopusServerNodeById(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OctopusServerNodesApi#getOctopusServerNodeById");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **String**| ID of the OctopusServerNode to load |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      OctopusServerNodeDetailsResource result = apiInstance.getOctopusServerNodeDetails(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OctopusServerNodesApi#getOctopusServerNodeDetails");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | OctopusServerNodeDetailsResource resource returned |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      OctopusServerNodeResourceCollection result = apiInstance.indexOctopusServerNodes(skip, take);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OctopusServerNodesApi#indexOctopusServerNodes");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
[**OctopusServerNodeResourceCollection**](OctopusServerNodeResourceCollection.md)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | ResourceCollection_of_OctopusServerNodeResource resource returned |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    OctopusServerNodesApi apiInstance = new OctopusServerNodesApi(defaultClient);
    String id = "id_example"; // String | ID of the OctopusServerNodeResource to modify
    OctopusServerNodeResource body = new OctopusServerNodeResource(); // OctopusServerNodeResource | The OctopusServerNodeResource resource to create
    try {
      OctopusServerNodeResource result = apiInstance.updateOctopusServerNode(id, body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OctopusServerNodesApi#updateOctopusServerNode");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | OctopusServerNodeResource Modified |  -  |
