...
> InlineResponse200 getPermissionDefinitions()
...
import com.octopus.client.api.PermissionsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      InlineResponse200 result = apiInstance.getPermissionDefinitions();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PermissionsApi#getPermissionDefinitions");
...
|-------------|-------------|------------------|
**200** | Dictionary_of_Permission,PermissionDescription resource returned |  -  |
