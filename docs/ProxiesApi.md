...
import com.octopus.client.api.ProxiesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ProxyResource body = new ProxyResource(); // ProxyResource | The ProxyResource resource to create
    try {
      ProxyResource result = apiInstance.createProxy(body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProxiesApi#createProxy");
...
------------- | ------------- | ------------- | -------------
 **body** | [**ProxyResource**](ProxyResource.md)| The ProxyResource resource to create | [optional]
...
public class Example {
  public static void main(String[] args) {
    ...
    ProxyResource body = new ProxyResource(); // ProxyResource | The ProxyResource resource to create
    try {
      ProxyResource result = apiInstance.createProxySpaces(baseSpaceId, body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProxiesApi#createProxySpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    ProxiesApi apiInstance = new ProxiesApi(defaultClient);
    String id = "id_example"; // String | ID of the ProxyResource to delete
    try {
      apiInstance.deleteProxy(id);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProxiesApi#deleteProxy");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String id = "id_example"; // String | ID of the ProxyResource to delete
    try {
      apiInstance.deleteProxySpaces(baseSpaceId, id);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProxiesApi#deleteProxySpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    ProxiesApi apiInstance = new ProxiesApi(defaultClient);
    String id = "id_example"; // String | ID of the Proxy to load
    try {
      ProxyResource result = apiInstance.getProxyById(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProxiesApi#getProxyById");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **String**| ID of the Proxy to load |
...
public class Example {
  public static void main(String[] args) {
    ...
    String baseSpaceId = "baseSpaceId_example"; // String | ID of the space
    try {
      ProxyResource result = apiInstance.getProxyByIdSpaces(id, baseSpaceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProxiesApi#getProxyByIdSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ProxyResourceCollection result = apiInstance.indexProxies(skip, take);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProxiesApi#indexProxies");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
[**ProxyResourceCollection**](ProxyResourceCollection.md)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | ResourceCollection_of_ProxyResource resource returned |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer take = 56; // Integer | Number of items to take
    try {
      ProxyResourceCollection result = apiInstance.indexProxiesSpaces(baseSpaceId, skip, take);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProxiesApi#indexProxiesSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
# **listAllProxies**
> List&lt;ProxyResource&gt; listAllProxies()
...
public class Example {
  public static void main(String[] args) {
    ...
    ProxiesApi apiInstance = new ProxiesApi(defaultClient);
    try {
      List<ProxyResource> result = apiInstance.listAllProxies();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProxiesApi#listAllProxies");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
> List&lt;ProxyResource&gt; listAllProxiesSpaces(baseSpaceId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String baseSpaceId = "baseSpaceId_example"; // String | ID of the space
    try {
      List<ProxyResource> result = apiInstance.listAllProxiesSpaces(baseSpaceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProxiesApi#listAllProxiesSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    ProxiesApi apiInstance = new ProxiesApi(defaultClient);
    String id = "id_example"; // String | ID of the ProxyResource to modify
    ProxyResource body = new ProxyResource(); // ProxyResource | The ProxyResource resource to create
    try {
      ProxyResource result = apiInstance.updateProxy(id, body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProxiesApi#updateProxy");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    ProxyResource body = new ProxyResource(); // ProxyResource | The ProxyResource resource to create
    try {
      ProxyResource result = apiInstance.updateProxySpaces(baseSpaceId, id, body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProxiesApi#updateProxySpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
