...
import com.octopus.client.api.RunbookRunsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    RunbookRunsApi apiInstance = new RunbookRunsApi(defaultClient);
    try {
      RunbookRunResource result = apiInstance.createRunbookRunCreate();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling RunbookRunsApi#createRunbookRunCreate");
...
**400** | License is not compliant.  No request body was supplied.  RunbookRun creation failed.  RunbookRun Schedule is invalid. |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      RunbookRunResource result = apiInstance.createRunbookRunCreateSpaces(baseSpaceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling RunbookRunsApi#createRunbookRunCreateSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    RunbookRunsApi apiInstance = new RunbookRunsApi(defaultClient);
    String id = "id_example"; // String | ID of the RunbookRunResource to delete
    try {
      apiInstance.deleteRunbookRun(id);
    } catch (ApiException e) {
      System.err.println("Exception when calling RunbookRunsApi#deleteRunbookRun");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **String**| ID of the RunbookRunResource to delete |
...
public class Example {
  public static void main(String[] args) {
    ...
    String id = "id_example"; // String | ID of the RunbookRunResource to delete
    try {
      apiInstance.deleteRunbookRunSpaces(baseSpaceId, id);
    } catch (ApiException e) {
      System.err.println("Exception when calling RunbookRunsApi#deleteRunbookRunSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    RunbookRunsApi apiInstance = new RunbookRunsApi(defaultClient);
    String id = "id_example"; // String | ID of the RunbookRun to load
    try {
      RunbookRunResource result = apiInstance.getRunbookRunById(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling RunbookRunsApi#getRunbookRunById");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **String**| ID of the RunbookRun to load |
...
public class Example {
  public static void main(String[] args) {
    ...
    String baseSpaceId = "baseSpaceId_example"; // String | ID of the space
    try {
      RunbookRunResource result = apiInstance.getRunbookRunByIdSpaces(id, baseSpaceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling RunbookRunsApi#getRunbookRunByIdSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      RunbookRunResourceCollection result = apiInstance.indexRunbookRuns(skip, take);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling RunbookRunsApi#indexRunbookRuns");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | ResourceCollection_of_RunbookRunResource resource returned |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer take = 56; // Integer | Number of items to take
    try {
      RunbookRunResourceCollection result = apiInstance.indexRunbookRunsSpaces(baseSpaceId, skip, take);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling RunbookRunsApi#indexRunbookRunsSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
