...
import com.octopus.client.api.SchedulerApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    String name = "name_example"; // String | Name of the task
    try {
      ScheduledTaskDetailsResource result = apiInstance.getScheduledTaskDetails(name);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SchedulerApi#getScheduledTaskDetails");
...
|-------------|-------------|------------------|
**200** | ScheduledTaskDetailsResource resource returned |  -  |
**400** | No name parameter was provided. |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    SchedulerApi apiInstance = new SchedulerApi(defaultClient);
    String name = "name_example"; // String | Name of the scheduled task
    try {
      apiInstance.getScheduledTaskRawDetails(name);
    } catch (ApiException e) {
      System.err.println("Exception when calling SchedulerApi#getScheduledTaskRawDetails");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    SchedulerApi apiInstance = new SchedulerApi(defaultClient);
    try {
      SchedulerStatusResource result = apiInstance.getScheduler();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SchedulerApi#getScheduler");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | SchedulerStatusResource resource returned |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    SchedulerApi apiInstance = new SchedulerApi(defaultClient);
    try {
      apiInstance.getSchedulerStart();
    } catch (ApiException e) {
      System.err.println("Exception when calling SchedulerApi#getSchedulerStart");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    SchedulerApi apiInstance = new SchedulerApi(defaultClient);
    try {
      apiInstance.getSchedulerStop();
    } catch (ApiException e) {
      System.err.println("Exception when calling SchedulerApi#getSchedulerStop");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    SchedulerApi apiInstance = new SchedulerApi(defaultClient);
    try {
      apiInstance.getSchedulerTrigger();
    } catch (ApiException e) {
      System.err.println("Exception when calling SchedulerApi#getSchedulerTrigger");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
