...
import com.octopus.client.api.ServerConfigurationApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ServerConfigurationResource result = apiInstance.getServerConfiguration();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServerConfigurationApi#getServerConfiguration");
...
|-------------|-------------|------------------|
**200** | ServerConfigurationResource resource returned |  -  |

<a name="getServerConfigurationSettingsList"></a>
# **getServerConfigurationSettingsList**
> List&lt;ServerConfigurationSettingsResource&gt; getServerConfigurationSettingsList()
...
public class Example {
  public static void main(String[] args) {
    ...
    ServerConfigurationApi apiInstance = new ServerConfigurationApi(defaultClient);
    try {
      List<ServerConfigurationSettingsResource> result = apiInstance.getServerConfigurationSettingsList();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServerConfigurationApi#getServerConfigurationSettingsList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | IEnumerable_of_ServerConfigurationSettingsResource resource returned |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    ServerConfigurationApi apiInstance = new ServerConfigurationApi(defaultClient);
    try {
      apiInstance.updateServerConfiguration();
    } catch (ApiException e) {
      System.err.println("Exception when calling ServerConfigurationApi#updateServerConfiguration");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
