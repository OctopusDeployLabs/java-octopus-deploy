...
import com.octopus.client.api.ServerStatusApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ServerStatusApi apiInstance = new ServerStatusApi(defaultClient);
    try {
      apiInstance.createSystemGarbageCollect();
    } catch (ApiException e) {
      System.err.println("Exception when calling ServerStatusApi#createSystemGarbageCollect");
...
# **getExtensionStats**
> List&lt;ExtensionsInfoResource&gt; getExtensionStats()
...
public class Example {
  public static void main(String[] args) {
    ...
    ServerStatusApi apiInstance = new ServerStatusApi(defaultClient);
    try {
      List<ExtensionsInfoResource> result = apiInstance.getExtensionStats();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServerStatusApi#getExtensionStats");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
|-------------|-------------|------------------|
**200** | IEnumerable_of_ExtensionsInfoResource resource returned |  -  |

<a name="getListServerTimezones"></a>
# **getListServerTimezones**
> List&lt;ServerTimezoneResource&gt; getListServerTimezones()
...
public class Example {
  public static void main(String[] args) {
    ...
    ServerStatusApi apiInstance = new ServerStatusApi(defaultClient);
    try {
      List<ServerTimezoneResource> result = apiInstance.getListServerTimezones();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServerStatusApi#getListServerTimezones");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | IEnumerable_of_ServerTimezoneResource resource returned |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    ServerStatusApi apiInstance = new ServerStatusApi(defaultClient);
    try {
      apiInstance.getRecentLogs();
    } catch (ApiException e) {
      System.err.println("Exception when calling ServerStatusApi#getRecentLogs");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    ServerStatusApi apiInstance = new ServerStatusApi(defaultClient);
    try {
      apiInstance.getServerStatus();
    } catch (ApiException e) {
      System.err.println("Exception when calling ServerStatusApi#getServerStatus");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    ServerStatusApi apiInstance = new ServerStatusApi(defaultClient);
    try {
      ServerStatusHealthResource result = apiInstance.getServerStatusHealth();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServerStatusApi#getServerStatusHealth");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | ServerStatusHealthResource resource returned |  -  |
**418** | ServerStatusHealthResource resource returned |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling ServerStatusApi#getSystemInfo");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    ServerStatusApi apiInstance = new ServerStatusApi(defaultClient);
    try {
      apiInstance.getSystemReport();
    } catch (ApiException e) {
      System.err.println("Exception when calling ServerStatusApi#getSystemReport");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
