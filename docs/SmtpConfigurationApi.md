...
import com.octopus.client.api.SmtpConfigurationApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    SmtpConfigurationApi apiInstance = new SmtpConfigurationApi(defaultClient);
    try {
      apiInstance.getSmtpConfiguration();
    } catch (ApiException e) {
      System.err.println("Exception when calling SmtpConfigurationApi#getSmtpConfiguration");
...
public class Example {
  public static void main(String[] args) {
    ...
    SmtpConfigurationApi apiInstance = new SmtpConfigurationApi(defaultClient);
    try {
      SmtpIsConfiguredResource result = apiInstance.getSmtpIsConfigured();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SmtpConfigurationApi#getSmtpIsConfigured");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
|-------------|-------------|------------------|
**200** | SmtpIsConfiguredResource resource returned |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    SmtpConfigurationApi apiInstance = new SmtpConfigurationApi(defaultClient);
    try {
      apiInstance.updateSmtpConfiguration();
    } catch (ApiException e) {
      System.err.println("Exception when calling SmtpConfigurationApi#updateSmtpConfiguration");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
