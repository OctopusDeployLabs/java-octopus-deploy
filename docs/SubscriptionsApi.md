...
# **getAllSubscriptions**
> List&lt;SubscriptionResource&gt; getAllSubscriptions()
...
import com.octopus.client.api.SubscriptionsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<SubscriptionResource> result = apiInstance.getAllSubscriptions();
...
> List&lt;SubscriptionResource&gt; getAllSubscriptionsSpaces(baseSpaceId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<SubscriptionResource> result = apiInstance.getAllSubscriptionsSpaces(baseSpaceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SubscriptionsApi#getAllSubscriptionsSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    SubscriptionsApi apiInstance = new SubscriptionsApi(defaultClient);
    String id = "id_example"; // String | ID of the Subscription to load
    try {
      SubscriptionResource result = apiInstance.getSubscriptionById(id);
      System.out.println(result);
    } catch (ApiException e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **String**| ID of the Subscription to load |
...
public class Example {
  public static void main(String[] args) {
    ...
    String baseSpaceId = "baseSpaceId_example"; // String | ID of the space
    try {
      SubscriptionResource result = apiInstance.getSubscriptionByIdSpaces(id, baseSpaceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SubscriptionsApi#getSubscriptionByIdSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
