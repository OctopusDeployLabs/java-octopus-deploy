...
import com.octopus.client.api.UserOnboardingApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      OnboardingResource result = apiInstance.getOnboarding();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling UserOnboardingApi#getOnboarding");
...
|-------------|-------------|------------------|
**200** | OnboardingResource resource returned |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      OnboardingResource result = apiInstance.getOnboardingSpaces(baseSpaceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling UserOnboardingApi#getOnboardingSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
