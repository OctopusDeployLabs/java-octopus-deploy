...
import com.octopus.client.api.UserPermissionsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      UserPermissionSetResource result = apiInstance.getUserGetPermissions(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling UserPermissionsApi#getUserGetPermissions");
...
|-------------|-------------|------------------|
**200** | UserPermissionSetResource resource returned |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    String id = "id_example"; // String | ID of the resource
    try {
      UserPermissionSetResource result = apiInstance.getUserGetPermissionsConfiguration(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling UserPermissionsApi#getUserGetPermissionsConfiguration");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String id = "id_example"; // String | ID of the resource
    try {
      UserPermissionSetResource result = apiInstance.getUserGetPermissionsConfigurationSpaces(baseSpaceId, id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling UserPermissionsApi#getUserGetPermissionsConfigurationSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String id = "id_example"; // String | ID of the resource
    try {
      UserPermissionSetResource result = apiInstance.getUserGetPermissionsSpaces(baseSpaceId, id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling UserPermissionsApi#getUserGetPermissionsSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.getUserPermissionsExport(id);
    } catch (ApiException e) {
      System.err.println("Exception when calling UserPermissionsApi#getUserPermissionsExport");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String id = "id_example"; // String | ID of the user
    try {
      apiInstance.getUserPermissionsExportSpaces(baseSpaceId, id);
    } catch (ApiException e) {
      System.err.println("Exception when calling UserPermissionsApi#getUserPermissionsExportSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
