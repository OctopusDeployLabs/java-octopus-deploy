...
import com.octopus.client.api.UserRolesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    UserRoleResource body = new UserRoleResource(); // UserRoleResource | The UserRoleResource resource to create
    try {
      UserRoleResource result = apiInstance.createUserRole(body);
...
public class Example {
  public static void main(String[] args) {
    ...
    UserRolesApi apiInstance = new UserRolesApi(defaultClient);
    String id = "id_example"; // String | ID of the UserRoleResource to delete
    try {
...
public class Example {
  public static void main(String[] args) {
    ...
    UserRolesApi apiInstance = new UserRolesApi(defaultClient);
    String id = "id_example"; // String | ID of the UserRole to load
    try {
      UserRoleResource result = apiInstance.getUserRoleById(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling UserRolesApi#getUserRoleById");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **String**| ID of the UserRole to load |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      UserRoleResourceCollection result = apiInstance.indexUserRoles(skip, take);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling UserRolesApi#indexUserRoles");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
[**UserRoleResourceCollection**](UserRoleResourceCollection.md)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | ResourceCollection_of_UserRoleResource resource returned |  -  |

<a name="listAllUserRoles"></a>
# **listAllUserRoles**
> List&lt;UserRoleResource&gt; listAllUserRoles()
...
public class Example {
  public static void main(String[] args) {
    ...
    UserRolesApi apiInstance = new UserRolesApi(defaultClient);
    try {
      List<UserRoleResource> result = apiInstance.listAllUserRoles();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling UserRolesApi#listAllUserRoles");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    UserRolesApi apiInstance = new UserRolesApi(defaultClient);
    String id = "id_example"; // String | ID of the UserRoleResource to modify
    UserRoleResource body = new UserRoleResource(); // UserRoleResource | The UserRoleResource resource to create
    try {
      UserRoleResource result = apiInstance.updateUserRole(id, body);
      System.out.println(result);
    } catch (ApiException e) {
