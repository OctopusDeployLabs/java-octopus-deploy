...
# **getUserGetTeams**
> List&lt;ProjectedTeamReferenceDataItem&gt; getUserGetTeams(id)
...
import com.octopus.client.api.UserTeamsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<ProjectedTeamReferenceDataItem> result = apiInstance.getUserGetTeams(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling UserTeamsApi#getUserGetTeams");
...
|-------------|-------------|------------------|
**200** | IEnumerable_of_ProjectedTeamReferenceDataItem resource returned |  -  |
**400** | No id parameter was provided. |  -  |

<a name="getUserGetTeamsSpaces"></a>
# **getUserGetTeamsSpaces**
> List&lt;ProjectedTeamReferenceDataItem&gt; getUserGetTeamsSpaces(baseSpaceId, id)
...
public class Example {
  public static void main(String[] args) {
    ...
    String id = "id_example"; // String | ID of the resource
    try {
      List<ProjectedTeamReferenceDataItem> result = apiInstance.getUserGetTeamsSpaces(baseSpaceId, id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling UserTeamsApi#getUserGetTeamsSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
