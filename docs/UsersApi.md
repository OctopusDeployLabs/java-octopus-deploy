...
import com.octopus.client.api.UsersApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      UserResource result = apiInstance.createUserCreate();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling UsersApi#createUserCreate");
...
|-------------|-------------|------------------|
**201** | UserResource resource returned |  -  |
**400** | Model validation failed.  No request body was supplied.  User creation failed.  Username is reserved and can&#39;t be used to create new users.  You cannot add multiple logins for the same identity provider. |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    UsersApi apiInstance = new UsersApi(defaultClient);
    try {
      apiInstance.createUserLogin();
    } catch (ApiException e) {
      System.err.println("Exception when calling UsersApi#createUserLogin");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    UsersApi apiInstance = new UsersApi(defaultClient);
    try {
      apiInstance.createUserLogout();
    } catch (ApiException e) {
      System.err.println("Exception when calling UsersApi#createUserLogout");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    UsersApi apiInstance = new UsersApi(defaultClient);
    try {
      apiInstance.createUserRegister();
    } catch (ApiException e) {
      System.err.println("Exception when calling UsersApi#createUserRegister");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    UsersApi apiInstance = new UsersApi(defaultClient);
    String id = "id_example"; // String | ID of the UserResource to delete
    try {
...
public class Example {
  public static void main(String[] args) {
    ...
    UsersApi apiInstance = new UsersApi(defaultClient);
    try {
      UserAuthenticationResource result = apiInstance.getUserAuthentication();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling UsersApi#getUserAuthentication");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | UserAuthenticationResource resource returned |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    UsersApi apiInstance = new UsersApi(defaultClient);
    String userId = "userId_example"; // String | ID of the resource being edited
    try {
      UserAuthenticationResource result = apiInstance.getUserAuthentication1(userId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling UsersApi#getUserAuthentication1");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **userId** | **String**| ID of the resource being edited |
...
public class Example {
  public static void main(String[] args) {
    ...
    UsersApi apiInstance = new UsersApi(defaultClient);
    String id = "id_example"; // String | ID of the User to load
    try {
      UserResource result = apiInstance.getUserById(id);
      System.out.println(result);
    } catch (ApiException e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **String**| ID of the User to load |
...
public class Example {
  public static void main(String[] args) {
    ...
    UsersApi apiInstance = new UsersApi(defaultClient);
    try {
      apiInstance.getUserExternalSearch();
    } catch (ApiException e) {
      System.err.println("Exception when calling UsersApi#getUserExternalSearch");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    UsersApi apiInstance = new UsersApi(defaultClient);
    try {
      apiInstance.getUserGetCurrent();
    } catch (ApiException e) {
      System.err.println("Exception when calling UsersApi#getUserGetCurrent");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.getUserGetSpaces(id);
    } catch (ApiException e) {
      System.err.println("Exception when calling UsersApi#getUserGetSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    UsersApi apiInstance = new UsersApi(defaultClient);
    try {
      apiInstance.getUserIdentityMetadata();
    } catch (ApiException e) {
      System.err.println("Exception when calling UsersApi#getUserIdentityMetadata");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      UserResourceCollection result = apiInstance.indexUsers(skip, take);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling UsersApi#indexUsers");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
[**UserResourceCollection**](UserResourceCollection.md)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | ResourceCollection_of_UserResource resource returned |  -  |

<a name="listAllUsers"></a>
# **listAllUsers**
> List&lt;UserResource&gt; listAllUsers()
...
public class Example {
  public static void main(String[] args) {
    ...
    UsersApi apiInstance = new UsersApi(defaultClient);
    try {
      List<UserResource> result = apiInstance.listAllUsers();
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    String id = "id_example"; // String | ID of the resource
    try {
      UserResource result = apiInstance.updateUser(id);
      System.out.println(result);
    } catch (ApiException e) {
...
**400** | A user with a matching external login already exists.  No id parameter was provided.  No request body was supplied.  Passwords cannot be set for service user accounts.  You cannot add multiple logins for the same identity provider. |  -  |
