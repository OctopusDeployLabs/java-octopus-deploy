...
import com.octopus.client.api.VariablesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.getVariableNamesList();
    } catch (ApiException e) {
      System.err.println("Exception when calling VariablesApi#getVariableNamesList");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.getVariableNamesListSpaces(baseSpaceId);
    } catch (ApiException e) {
      System.err.println("Exception when calling VariablesApi#getVariableNamesListSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    VariablesApi apiInstance = new VariablesApi(defaultClient);
    try {
      VariableSetResource result = apiInstance.getVariablePreviewList();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling VariablesApi#getVariablePreviewList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
|-------------|-------------|------------------|
**200** | VariableSetResource resource returned |  -  |
**400** | No project was provided. |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    String baseSpaceId = "baseSpaceId_example"; // String | ID of the space
    try {
      VariableSetResource result = apiInstance.getVariablePreviewListSpaces(baseSpaceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling VariablesApi#getVariablePreviewListSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    VariablesApi apiInstance = new VariablesApi(defaultClient);
    String id = "id_example"; // String | ID of the VariableSetResource to load
    try {
      VariableSetResource result = apiInstance.getVariableSetById(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling VariablesApi#getVariableSetById");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Load VariableSetResource by ID |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    String id = "id_example"; // String | ID of the VariableSetResource to load
    try {
      VariableSetResource result = apiInstance.getVariableSetByIdSpaces(baseSpaceId, id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling VariablesApi#getVariableSetByIdSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
# **listAllVariableSets**
> List&lt;VariableSetResource&gt; listAllVariableSets()
...
public class Example {
  public static void main(String[] args) {
    ...
    VariablesApi apiInstance = new VariablesApi(defaultClient);
    try {
      List<VariableSetResource> result = apiInstance.listAllVariableSets();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling VariablesApi#listAllVariableSets");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Load all VariableSetResource |  -  |

<a name="listAllVariableSetsSpaces"></a>
# **listAllVariableSetsSpaces**
> List&lt;VariableSetResource&gt; listAllVariableSetsSpaces(baseSpaceId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String baseSpaceId = "baseSpaceId_example"; // String | ID of the space
    try {
      List<VariableSetResource> result = apiInstance.listAllVariableSetsSpaces(baseSpaceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling VariablesApi#listAllVariableSetsSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      VariableSetResource result = apiInstance.updateVariableSet(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling VariablesApi#updateVariableSet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
|-------------|-------------|------------------|
**200** | VariableSetResource resource returned |  -  |
**400** | Changes to these variables could not be saved, because another user has made changes to the variables between when you started editing and when you saved your changes. Please reload or open a new tab to make your changes.  Changes to these variables could not be saved, because your available environment scopes changed while you were editing the variables. Please reload or open a new tab to make your changes.  Converting a project with variables scoped to processes or deployment steps to version control is not supported.  No id parameter was provided.  No request body was supplied.  Prompted variables cannot be scoped to anything except an environment.  Variable ids must be unique.  Variable set only scoped to owner.  Variable validation failed.  You cannot modify this variable set because the set is frozen. You&#39;ll need to create a new variable set instead. |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    String id = "id_example"; // String | ID of the resource
    try {
      VariableSetResource result = apiInstance.updateVariableSetSpaces(baseSpaceId, id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling VariablesApi#updateVariableSetSpaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
