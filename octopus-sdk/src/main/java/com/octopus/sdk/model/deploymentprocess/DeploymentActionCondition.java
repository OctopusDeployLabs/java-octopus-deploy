...
public enum DeploymentActionCondition {
  ...
  DeploymentActionCondition(String value) {
    this.value = value;
  }
  ...
  public static class Adapter extends TypeAdapter<DeploymentActionCondition> {
    @Override
    public void write(final JsonWriter jsonWriter, final DeploymentActionCondition enumeration)
        throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DeploymentActionCondition read(final JsonReader jsonReader) throws IOException {
