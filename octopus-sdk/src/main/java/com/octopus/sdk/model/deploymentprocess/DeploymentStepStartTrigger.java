...
public enum DeploymentStepStartTrigger {
  ...
  DeploymentStepStartTrigger(String value) {
    this.value = value;
  }
  ...
  public static class Adapter extends TypeAdapter<DeploymentStepStartTrigger> {
    @Override
    public void write(final JsonWriter jsonWriter, final DeploymentStepStartTrigger enumeration)
        throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DeploymentStepStartTrigger read(final JsonReader jsonReader) throws IOException {
