...
public class ReleaseExecutor {
  ...
  public ReleaseExecutor(final OctopusClient client,
      final ReleaseResourceWithLinks resourceWithLinks) {
    this.client = client;
  ...
  public ProjectExecutor getProject() throws IOException {
    final ProjectResourceWithLinks resource =
        client.get(RequestEndpoint.fromPath(resourceWithLinks.getProjectLink()), ProjectResourceWithLinks.class);
