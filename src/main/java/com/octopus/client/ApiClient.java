...
import com.octopus.client.auth.ApiKeyAuth;
import com.octopus.client.auth.Authentication;
import com.octopus.client.auth.HttpBasicAuth;
import com.octopus.client.auth.HttpBearerAuth;
import java.io.File;
...
public class ApiClient {
  ...
  public ApiClient() {
    ...
    authentications.put("APIKeyHeader",
                        new ApiKeyAuth("header", "X-Octopus-ApiKey"));
    authentications.put("APIKeyQuery", new ApiKeyAuth("query", "ApiKey"));
    authentications.put("NugetApiKeyHeader",
                        new ApiKeyAuth("header", "X-NuGet-ApiKey"));
  ...
  private void init() {
    ...
    setUserAgent("OpenAPI-Generator/2021.2.1387/java");
   ...
   */
  public boolean isVerifyingSsl() { return verifyingSsl; }
  ...
  public KeyManager[] getKeyManagers() { return keyManagers; }
   ...
   */
  public int getConnectTimeout() { return httpClient.connectTimeoutMillis(); }
   ...
   * @return Timeout in milliseconds
   */
  public int getReadTimeout() { return httpClient.readTimeoutMillis(); }
   ...
   * @return Timeout in milliseconds
   */
  public int getWriteTimeout() { return httpClient.writeTimeoutMillis(); }
  ...
  public <T> ApiResponse<T> execute(Call call, Type returnType)
    ...
    try {
      ...
      return new ApiResponse<T>(response.code(),
        ...
        trustManagers = new TrustManager[] {new X509TrustManager(){
            ...
            @Override public void checkServerTrusted(
                ...
                throws CertificateException{}
                       ...
                       @Override public java.security.cert
                           .X509Certificate[] getAcceptedIssuers(){
                               return new java.security.cert
                                   .X509Certificate[] {};
      }
    }
  };
