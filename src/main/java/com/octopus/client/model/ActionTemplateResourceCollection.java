...
import com.octopus.client.model.ActionTemplateResource;
...
public class ActionTemplateResourceCollection {
  ...
  public ActionTemplateResourceCollection id(String id) {
  ...
  public ActionTemplateResourceCollection
  items(List<ActionTemplateResource> items) {
  ...
  public ActionTemplateResourceCollection
  addItemsItem(ActionTemplateResource itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<ActionTemplateResource>();
    }
  ...
  public void setItems(List<ActionTemplateResource> items) {
    this.items = items;
  }

  public ActionTemplateResourceCollection itemsPerPage(Integer itemsPerPage) {
  ...
  public ActionTemplateResourceCollection links(Map<String, String> links) {

    this.links = links;
    return this;
  }

  public ActionTemplateResourceCollection putLinksItem(String key,
                                                       String linksItem) {
    if (this.links == null) {
  ...
  public ActionTemplateResourceCollection totalResults(Integer totalResults) {
  ...
  public boolean equals(Object o) {
    ...
    ActionTemplateResourceCollection actionTemplateResourceCollection =
        (ActionTemplateResourceCollection)o;
    return Objects.equals(this.id, actionTemplateResourceCollection.id) &&
        Objects.equals(this.items, actionTemplateResourceCollection.items) &&
        Objects.equals(this.itemsPerPage,
                       actionTemplateResourceCollection.itemsPerPage) &&
        Objects.equals(this.itemType,
                       actionTemplateResourceCollection.itemType) &&
        Objects.equals(this.lastModifiedBy,
                       actionTemplateResourceCollection.lastModifiedBy) &&
        Objects.equals(this.lastModifiedOn,
                       actionTemplateResourceCollection.lastModifiedOn) &&
        Objects.equals(this.lastPageNumber,
                       actionTemplateResourceCollection.lastPageNumber) &&
        Objects.equals(this.links, actionTemplateResourceCollection.links) &&
        Objects.equals(this.numberOfPages,
                       actionTemplateResourceCollection.numberOfPages) &&
        Objects.equals(this.totalResults,
                       actionTemplateResourceCollection.totalResults);
  }
