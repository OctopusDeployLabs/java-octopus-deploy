...
import com.octopus.client.model.CertificateConfigurationResource;
...
public class CertificateConfigurationResourceCollection {
  public static final String SERIALIZED_NAME_ID = "Id";
  @SerializedName(SERIALIZED_NAME_ID) private String id;

  public static final String SERIALIZED_NAME_ITEMS = "Items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<CertificateConfigurationResource> items = null;
  ...
  public CertificateConfigurationResourceCollection id(String id) {
  ...
  public CertificateConfigurationResourceCollection
  items(List<CertificateConfigurationResource> items) {
  ...
  public CertificateConfigurationResourceCollection
  addItemsItem(CertificateConfigurationResource itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<CertificateConfigurationResource>();
    }
  ...
  public List<CertificateConfigurationResource> getItems() {
    return items;
  }

  public void setItems(List<CertificateConfigurationResource> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    CertificateConfigurationResourceCollection
        certificateConfigurationResourceCollection =
            (CertificateConfigurationResourceCollection)o;
    return Objects.equals(this.id,
                          certificateConfigurationResourceCollection.id) &&
        Objects.equals(this.items,
                       certificateConfigurationResourceCollection.items) &&
        Objects.equals(
            this.itemsPerPage,
            certificateConfigurationResourceCollection.itemsPerPage) &&
        Objects.equals(this.itemType,
                       certificateConfigurationResourceCollection.itemType) &&
        Objects.equals(
            this.lastModifiedBy,
            certificateConfigurationResourceCollection.lastModifiedBy) &&
        Objects.equals(
            this.lastModifiedOn,
            certificateConfigurationResourceCollection.lastModifiedOn) &&
        Objects.equals(
            this.lastPageNumber,
            certificateConfigurationResourceCollection.lastPageNumber) &&
        Objects.equals(this.links,
                       certificateConfigurationResourceCollection.links) &&
        Objects.equals(
            this.numberOfPages,
            certificateConfigurationResourceCollection.numberOfPages) &&
        Objects.equals(this.totalResults,
                       certificateConfigurationResourceCollection.totalResults);
  }
  ...
  public String toString() {
    ...
    sb.append("class CertificateConfigurationResourceCollection {\n");
