...
import com.octopus.client.model.CommunityActionTemplateResource;
...
public class CommunityActionTemplateResourceCollection {
  public static final String SERIALIZED_NAME_ID = "Id";
  @SerializedName(SERIALIZED_NAME_ID) private String id;

  public static final String SERIALIZED_NAME_ITEMS = "Items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<CommunityActionTemplateResource> items = null;
  ...
  public CommunityActionTemplateResourceCollection id(String id) {
  ...
  public CommunityActionTemplateResourceCollection
  items(List<CommunityActionTemplateResource> items) {
  ...
  public CommunityActionTemplateResourceCollection
  addItemsItem(CommunityActionTemplateResource itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<CommunityActionTemplateResource>();
    }
  ...
  public List<CommunityActionTemplateResource> getItems() {
    return items;
  }

  public void setItems(List<CommunityActionTemplateResource> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    CommunityActionTemplateResourceCollection
        communityActionTemplateResourceCollection =
            (CommunityActionTemplateResourceCollection)o;
    return Objects.equals(this.id,
                          communityActionTemplateResourceCollection.id) &&
        Objects.equals(this.items,
                       communityActionTemplateResourceCollection.items) &&
        Objects.equals(
            this.itemsPerPage,
            communityActionTemplateResourceCollection.itemsPerPage) &&
        Objects.equals(this.itemType,
                       communityActionTemplateResourceCollection.itemType) &&
        Objects.equals(
            this.lastModifiedBy,
            communityActionTemplateResourceCollection.lastModifiedBy) &&
        Objects.equals(
            this.lastModifiedOn,
            communityActionTemplateResourceCollection.lastModifiedOn) &&
        Objects.equals(
            this.lastPageNumber,
            communityActionTemplateResourceCollection.lastPageNumber) &&
        Objects.equals(this.links,
                       communityActionTemplateResourceCollection.links) &&
        Objects.equals(
            this.numberOfPages,
            communityActionTemplateResourceCollection.numberOfPages) &&
        Objects.equals(this.totalResults,
                       communityActionTemplateResourceCollection.totalResults);
  }
  ...
  public String toString() {
    ...
    sb.append("class CommunityActionTemplateResourceCollection {\n");
