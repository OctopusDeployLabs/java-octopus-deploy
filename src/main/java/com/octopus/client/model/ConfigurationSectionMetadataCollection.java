...
import com.octopus.client.model.ConfigurationSectionMetadata;
...
public class ConfigurationSectionMetadataCollection {
  public static final String SERIALIZED_NAME_ID = "Id";
  @SerializedName(SERIALIZED_NAME_ID) private String id;

  public static final String SERIALIZED_NAME_ITEMS = "Items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<ConfigurationSectionMetadata> items = null;
  ...
  public ConfigurationSectionMetadataCollection id(String id) {
  ...
  public ConfigurationSectionMetadataCollection
  items(List<ConfigurationSectionMetadata> items) {
  ...
  public ConfigurationSectionMetadataCollection
  addItemsItem(ConfigurationSectionMetadata itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<ConfigurationSectionMetadata>();
    }
  ...
  public List<ConfigurationSectionMetadata> getItems() {
    return items;
  }

  public void setItems(List<ConfigurationSectionMetadata> items) {
    this.items = items;
  }
  ...
  public ConfigurationSectionMetadataCollection putLinksItem(String key,
                                                             String linksItem) {
    if (this.links == null) {
  ...
  public boolean equals(Object o) {
    ...
    ConfigurationSectionMetadataCollection
        configurationSectionMetadataCollection =
            (ConfigurationSectionMetadataCollection)o;
    return Objects.equals(this.id, configurationSectionMetadataCollection.id) &&
        Objects.equals(this.items,
                       configurationSectionMetadataCollection.items) &&
        Objects.equals(this.itemsPerPage,
                       configurationSectionMetadataCollection.itemsPerPage) &&
        Objects.equals(this.itemType,
                       configurationSectionMetadataCollection.itemType) &&
        Objects.equals(this.lastModifiedBy,
                       configurationSectionMetadataCollection.lastModifiedBy) &&
        Objects.equals(this.lastModifiedOn,
                       configurationSectionMetadataCollection.lastModifiedOn) &&
        Objects.equals(this.lastPageNumber,
                       configurationSectionMetadataCollection.lastPageNumber) &&
        Objects.equals(this.links,
                       configurationSectionMetadataCollection.links) &&
        Objects.equals(this.numberOfPages,
                       configurationSectionMetadataCollection.numberOfPages) &&
        Objects.equals(this.totalResults,
                       configurationSectionMetadataCollection.totalResults);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConfigurationSectionMetadataCollection {\n");
