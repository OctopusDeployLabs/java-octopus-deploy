...
public class DeploymentEnvironmentSettingsMetadata {
  ...
  public DeploymentEnvironmentSettingsMetadata extensionId(String extensionId) {
  ...
  public DeploymentEnvironmentSettingsMetadata metadata(Metadata metadata) {
  ...
  public boolean equals(Object o) {
    ...
    DeploymentEnvironmentSettingsMetadata
        deploymentEnvironmentSettingsMetadata =
            (DeploymentEnvironmentSettingsMetadata)o;
    return Objects.equals(this.extensionId,
                          deploymentEnvironmentSettingsMetadata.extensionId) &&
        Objects.equals(this.metadata,
                       deploymentEnvironmentSettingsMetadata.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeploymentEnvironmentSettingsMetadata {\n");
