...
public class DeploymentProcessResource {
  ...
  public DeploymentProcessResource id(String id) {
  ...
  public DeploymentProcessResource links(Map<String, String> links) {

    this.links = links;
    return this;
  }

  public DeploymentProcessResource putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  public boolean equals(Object o) {
    ...
    DeploymentProcessResource deploymentProcessResource =
        (DeploymentProcessResource)o;
    return Objects.equals(this.id, deploymentProcessResource.id) &&
        Objects.equals(this.lastModifiedBy,
                       deploymentProcessResource.lastModifiedBy) &&
        Objects.equals(this.lastModifiedOn,
                       deploymentProcessResource.lastModifiedOn) &&
        Objects.equals(this.lastSnapshotId,
                       deploymentProcessResource.lastSnapshotId) &&
        Objects.equals(this.links, deploymentProcessResource.links) &&
  ...
  public int hashCode() {
    return Objects.hash(id, lastModifiedBy, lastModifiedOn, lastSnapshotId,
                        links, projectId, spaceId, steps, version);
  }
