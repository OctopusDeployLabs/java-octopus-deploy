...
public class DeploymentResourceCollection {
  ...
  private List<DeploymentResource> items = null;
  ...
  public DeploymentResourceCollection id(String id) {
  ...
  public DeploymentResourceCollection items(List<DeploymentResource> items) {
  ...
  addItemsItem(DeploymentResource itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<DeploymentResource>();
    }
  ...
  public List<DeploymentResource> getItems() {
    return items;
  }

  public void setItems(List<DeploymentResource> items) { this.items = items; }

  public DeploymentResourceCollection itemsPerPage(Integer itemsPerPage) {
  ...
  public DeploymentResourceCollection lastModifiedBy(String lastModifiedBy) {
  ...
  public DeploymentResourceCollection links(Map<String, String> links) {

    this.links = links;
    return this;
  }

  public DeploymentResourceCollection putLinksItem(String key,
                                                   String linksItem) {
    if (this.links == null) {
  ...
  public DeploymentResourceCollection totalResults(Integer totalResults) {
  ...
  public boolean equals(Object o) {
    ...
    DeploymentResourceCollection deploymentResourceCollection =
        (DeploymentResourceCollection)o;
    return Objects.equals(this.id, deploymentResourceCollection.id) &&
        Objects.equals(this.items, deploymentResourceCollection.items) &&
        Objects.equals(this.itemsPerPage,
                       deploymentResourceCollection.itemsPerPage) &&
        Objects.equals(this.itemType, deploymentResourceCollection.itemType) &&
        Objects.equals(this.lastModifiedBy,
                       deploymentResourceCollection.lastModifiedBy) &&
        Objects.equals(this.lastModifiedOn,
                       deploymentResourceCollection.lastModifiedOn) &&
        Objects.equals(this.lastPageNumber,
                       deploymentResourceCollection.lastPageNumber) &&
        Objects.equals(this.links, deploymentResourceCollection.links) &&
        Objects.equals(this.numberOfPages,
                       deploymentResourceCollection.numberOfPages) &&
        Objects.equals(this.totalResults,
                       deploymentResourceCollection.totalResults);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeploymentResourceCollection {\n");
