...
public class LibraryVariableSetResourceCollection {
  public static final String SERIALIZED_NAME_ID = "Id";
  @SerializedName(SERIALIZED_NAME_ID) private String id;

  public static final String SERIALIZED_NAME_ITEMS = "Items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<LibraryVariableSetResource> items = null;
  ...
  public LibraryVariableSetResourceCollection id(String id) {
  ...
  public LibraryVariableSetResourceCollection
  items(List<LibraryVariableSetResource> items) {
  ...
  public LibraryVariableSetResourceCollection
  addItemsItem(LibraryVariableSetResource itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<LibraryVariableSetResource>();
    }
  ...
  public List<LibraryVariableSetResource> getItems() {
    return items;
  }

  public void setItems(List<LibraryVariableSetResource> items) {
    this.items = items;
  }
  ...
  public LibraryVariableSetResourceCollection links(Map<String, String> links) {

    this.links = links;
    return this;
  }

  public LibraryVariableSetResourceCollection putLinksItem(String key,
                                                           String linksItem) {
    if (this.links == null) {
  ...
  public boolean equals(Object o) {
    ...
    LibraryVariableSetResourceCollection libraryVariableSetResourceCollection =
        (LibraryVariableSetResourceCollection)o;
    return Objects.equals(this.id, libraryVariableSetResourceCollection.id) &&
        Objects.equals(this.items,
                       libraryVariableSetResourceCollection.items) &&
        Objects.equals(this.itemsPerPage,
                       libraryVariableSetResourceCollection.itemsPerPage) &&
        Objects.equals(this.itemType,
                       libraryVariableSetResourceCollection.itemType) &&
        Objects.equals(this.lastModifiedBy,
                       libraryVariableSetResourceCollection.lastModifiedBy) &&
        Objects.equals(this.lastModifiedOn,
                       libraryVariableSetResourceCollection.lastModifiedOn) &&
        Objects.equals(this.lastPageNumber,
                       libraryVariableSetResourceCollection.lastPageNumber) &&
        Objects.equals(this.links,
                       libraryVariableSetResourceCollection.links) &&
        Objects.equals(this.numberOfPages,
                       libraryVariableSetResourceCollection.numberOfPages) &&
        Objects.equals(this.totalResults,
                       libraryVariableSetResourceCollection.totalResults);
  }
  ...
  public String toString() {
    ...
    sb.append("class LibraryVariableSetResourceCollection {\n");
