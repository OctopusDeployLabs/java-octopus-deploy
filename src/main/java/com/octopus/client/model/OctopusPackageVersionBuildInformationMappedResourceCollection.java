...
public class OctopusPackageVersionBuildInformationMappedResourceCollection {
  public static final String SERIALIZED_NAME_ID = "Id";
  @SerializedName(SERIALIZED_NAME_ID) private String id;

  public static final String SERIALIZED_NAME_ITEMS = "Items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<OctopusPackageVersionBuildInformationMappedResource> items =
      null;
  ...
  public OctopusPackageVersionBuildInformationMappedResourceCollection
  id(String id) {
  ...
  public OctopusPackageVersionBuildInformationMappedResourceCollection
  items(List<OctopusPackageVersionBuildInformationMappedResource> items) {
  ...
  public OctopusPackageVersionBuildInformationMappedResourceCollection
  addItemsItem(OctopusPackageVersionBuildInformationMappedResource itemsItem) {
    if (this.items == null) {
      this.items =
          new ArrayList<OctopusPackageVersionBuildInformationMappedResource>();
    }
  ...
  public List<OctopusPackageVersionBuildInformationMappedResource> getItems() {
    return items;
  }

  public void
  setItems(List<OctopusPackageVersionBuildInformationMappedResource> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    OctopusPackageVersionBuildInformationMappedResourceCollection
        octopusPackageVersionBuildInformationMappedResourceCollection =
            (OctopusPackageVersionBuildInformationMappedResourceCollection)o;
  ...
  public String toString() {
    ...
    sb.append(
        "class OctopusPackageVersionBuildInformationMappedResourceCollection {\n");
