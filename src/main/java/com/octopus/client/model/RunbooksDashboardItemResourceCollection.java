...
public class RunbooksDashboardItemResourceCollection {
  public static final String SERIALIZED_NAME_ID = "Id";
  @SerializedName(SERIALIZED_NAME_ID) private String id;

  public static final String SERIALIZED_NAME_ITEMS = "Items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<RunbooksDashboardItemResource> items = null;
  ...
  public RunbooksDashboardItemResourceCollection id(String id) {
  ...
  public RunbooksDashboardItemResourceCollection
  items(List<RunbooksDashboardItemResource> items) {
  ...
  public RunbooksDashboardItemResourceCollection
  addItemsItem(RunbooksDashboardItemResource itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<RunbooksDashboardItemResource>();
    }
  ...
  public List<RunbooksDashboardItemResource> getItems() {
    return items;
  }

  public void setItems(List<RunbooksDashboardItemResource> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    RunbooksDashboardItemResourceCollection
        runbooksDashboardItemResourceCollection =
            (RunbooksDashboardItemResourceCollection)o;
    return Objects.equals(this.id,
                          runbooksDashboardItemResourceCollection.id) &&
        Objects.equals(this.items,
                       runbooksDashboardItemResourceCollection.items) &&
        Objects.equals(this.itemsPerPage,
                       runbooksDashboardItemResourceCollection.itemsPerPage) &&
        Objects.equals(this.itemType,
                       runbooksDashboardItemResourceCollection.itemType) &&
        Objects.equals(
            this.lastModifiedBy,
            runbooksDashboardItemResourceCollection.lastModifiedBy) &&
        Objects.equals(
            this.lastModifiedOn,
            runbooksDashboardItemResourceCollection.lastModifiedOn) &&
        Objects.equals(
            this.lastPageNumber,
            runbooksDashboardItemResourceCollection.lastPageNumber) &&
        Objects.equals(this.links,
                       runbooksDashboardItemResourceCollection.links) &&
        Objects.equals(this.numberOfPages,
                       runbooksDashboardItemResourceCollection.numberOfPages) &&
        Objects.equals(this.totalResults,
                       runbooksDashboardItemResourceCollection.totalResults);
  }
  ...
  public String toString() {
    ...
    sb.append("class RunbooksDashboardItemResourceCollection {\n");
