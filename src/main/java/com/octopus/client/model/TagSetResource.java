...
import com.octopus.client.model.TagResource;
...
public class TagSetResource {
  ...
  @SerializedName(SERIALIZED_NAME_TAGS) private List<TagResource> tags = null;

  public TagSetResource description(String description) {
  ...
  public TagSetResource id(String id) {
  ...
  public TagSetResource links(Map<String, String> links) {

    this.links = links;
    return this;
  }

  public TagSetResource putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  public TagSetResource name(String name) {
  ...
  public TagSetResource addTagsItem(TagResource tagsItem) {
    if (this.tags == null) {
      this.tags = new ArrayList<TagResource>();
    }
  ...
  public void setTags(List<TagResource> tags) { this.tags = tags; }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, tagSetResource.description) &&
        Objects.equals(this.id, tagSetResource.id) &&
        Objects.equals(this.lastModifiedBy, tagSetResource.lastModifiedBy) &&
        Objects.equals(this.lastModifiedOn, tagSetResource.lastModifiedOn) &&
        Objects.equals(this.links, tagSetResource.links) &&
        Objects.equals(this.name, tagSetResource.name) &&
